...
class TestAuxiliaryFunctions(unittest.TestCase):
    def test_flatten_good_dictionary(self):
        ...
        self.assertEqual(
            flat_dictionary,
            {"kg": 1, "kilogram": 1, "g": 0.001, "gr": 0.001, "gram": 0.001},
        )
    ...
    def test_parser(self):
        ...
        self.assertEqual(
            p3.flat_units_dictionary,
            {"C/sK^2": 1, "C/minK^2": 1 / 60, "C/minuteK^2": 1 / 60},
        )
        # Check a simple case
...
class TestPhysicalQuantity(unittest.TestCase):
    ...
    def test_bad_creation(self):
        ...
        d = 3
        self.assertRaises(
            PhysicalQuantityError, PhysicalQuantity, d, "3m"
        )  # not a dimension
...
class TestTemperature(unittest.TestCase):
    ...
    known_values = [[273.15, 491.67, 0, 32], [373.15, 671.67, 100, 212]]
